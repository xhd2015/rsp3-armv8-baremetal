...
_Z9enableMMUv:
.LFB273:
	.file 3 "D:/Pool/eclipse-workspace_aarch64/newspace/raspiOS/src/arch/qemu_virt/main_run_user_application.cpp"
	.loc 3 227 0
	.cfi_startproc
	stp	x29, x30, [sp, -272]!
...
.LBE238:
	.loc 3 491 0
	// Start of user assembly
// 491 "D:/Pool/eclipse-workspace_aarch64/newspace/raspiOS/src/arch/qemu_virt/main_run_user_application.cpp" 1
	mov x0,sp 
	orr x0,x0,x24 
	mov sp,x0 
	orr x29,x29, x24 
...
.LDL1:
	.loc 3 494 0
// 494 "D:/Pool/eclipse-workspace_aarch64/newspace/raspiOS/src/arch/qemu_virt/main_run_user_application.cpp" 1
	afterMMUSet:
...
.LDL2:
	.loc 3 499 0
	// Start of user assembly
// 499 "D:/Pool/eclipse-workspace_aarch64/newspace/raspiOS/src/arch/qemu_virt/main_run_user_application.cpp" 1
	mainEnd:
...
.LVL652:
.L38:
	.loc 3 142 0 is_stmt 0 discriminator 3
	cmp	x2, 512
	beq	.L37
	.loc 3 144 0 is_stmt 1 discriminator 2
	lsl	x1, x2, 3
	ldrb	w3, [x20, x1]
.LVL653:
	and	w3, w3, -2
	strb	w3, [x20, x1]
	.loc 3 145 0 discriminator 2
	ldrb	w3, [x21, x1]
	and	w3, w3, -2
	strb	w3, [x21, x1]
...
.LVL680:
.L41:
	.loc 3 174 0 is_stmt 0 discriminator 3
	cmp	x3, 5
	beq	.L40
	.loc 3 176 0 is_stmt 1 discriminator 2
	lsl	x2, x3, 3
	add	x1, x19, x2
	str	xzr, [x19, x2]
...
.LVL692:
.L43:
	.loc 3 186 0 is_stmt 0 discriminator 3
	cmp	x2, 1
	bhi	.L42
	.loc 3 188 0 is_stmt 1 discriminator 2
	add	x0, x2, 508
	lsl	x0, x0, 3
	add	x1, x19, x0
	str	xzr, [x19, x0]
