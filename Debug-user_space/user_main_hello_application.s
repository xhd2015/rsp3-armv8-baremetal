	.arch armv8-a
	.file	"user_main_hello_application.cpp"
	.text
.Ltext0:
...
main:
.LFB166:
	.file 1 "../src/arch/user_space/user_main_hello_application.cpp"
	.loc 1 10 0
	.cfi_startproc
	sub	sp, sp, #16
...
.LBB12:
.LBB13:
	.file 3 "D:\\Pool\\eclipse-workspace_aarch64\\chap003\\include/arch/common_aarch64/exception/svc_call.h"
	.loc 3 50 0
	adrp	x2, .LC0
	add	x2, x2, :lo12:.LC0
	mov	x3, 0
...
.LFE166:
	...
	.align	3
.LC0:
	.string	"application in EL0\n"
	.zero	4
.LC1:
	.string	"application in EL1\n"
	.zero	4
.LC2:
	.string	"Hello Application\nd"
	.text
.Letext0:
	...
	.file 13 "D:\\Pool\\eclipse-workspace_aarch64\\chap003\\include/memory/MemoryManager.h"
	.file 14 "D:\\Pool\\eclipse-workspace_aarch64\\chap003\\include/kernel.h"
	.file 15 "<built-in>"
	.file 16 "D:\\Pool\\eclipse-workspace_aarch64\\chap003\\include/arch/common_aarch64/exception/exceptions.h"
...
.Ldebug_macro0:
	...
	.4byte	.Ldebug_macro6
	.byte	0x4
	.file 21 "D:\\Pool\\eclipse-workspace_aarch64\\chap003\\include/asm_instructions.h"
	.byte	0x3
	.uleb128 0xb
	.uleb128 0x15
	.byte	0x5
...
.LASF1049:
	.string	"operator<<"
.LASF1148:
	.string	"../src/arch/user_space/user_main_hello_application.cpp"
.LASF374:
