	.arch armv8-a
	.file	"main_verify_address_tag.cpp"
	.text
.Ltext0:
...
main:
.LFB28:
	.file 3 "../src/arch/qemu_virt/main_verify_address_tag.cpp"
	.loc 3 15 0
	.cfi_startproc
	stp	x29, x30, [sp, -64]!
...
// 19 "../src/arch/qemu_virt/main_verify_address_tag.cpp" 1
...
.LBE25:
	.loc 3 34 0
	// Start of user assembly
// 34 "../src/arch/qemu_virt/main_verify_address_tag.cpp" 1
	.global main_end 
	main_end:
...
.LASF960:
	.string	"../src/arch/qemu_virt/main_verify_address_tag.cpp"
.LASF886:
	.string	"uintmax_t"
.LASF403:
