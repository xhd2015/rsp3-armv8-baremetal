	.arch armv8.2-a+crc
	.file	"main_test_adrp_instruction.cpp"
	.text
.Ltext0:
...
main:
.LFB163:
	.file 2 "../src/arch/qemu_virt/main_test_adrp_instruction.cpp"
	.loc 2 48 0
	.cfi_startproc
	stp	x29, x30, [sp, -160]!
...
.LVL9:
	.loc 2 50 0
	// Start of user assembly
// 50 "../src/arch/qemu_virt/main_test_adrp_instruction.cpp" 1
	adr x26,local_label1 
	
// 0 "" 2
.LVL10:
	.loc 2 53 0
// 53 "../src/arch/qemu_virt/main_test_adrp_instruction.cpp" 1
	adr x25,local_label2 
	
// 0 "" 2
.LVL11:
	.loc 2 56 0
// 56 "../src/arch/qemu_virt/main_test_adrp_instruction.cpp" 1
	adr x24,local_label3 
...
.LVL12:
	...
	adrp	x1, label1
	add	x1, x1, :lo12:label1
	mov	x0, x21
	bl	_ZN6OutputlsEPVKv
.LVL13:
	adrp	x19, .LC0
...
.LVL18:
	.loc 2 60 0
	adrp	x1, local_label1
	add	x1, x1, :lo12:local_label1
	mov	x0, x21
	bl	_ZN6OutputlsEPVKv
.LVL19:
	mov	x1, x19
	bl	_ZN6OutputlsEPKc
.LVL20:
	adrp	x1, local_label2
	add	x1, x1, :lo12:local_label2
	bl	_ZN6OutputlsEPVKv
.LVL21:
	mov	x1, x19
	bl	_ZN6OutputlsEPKc
.LVL22:
	adrp	x23, local_label3
	add	x23, x23, :lo12:local_label3
	mov	x1, x23
	bl	_ZN6OutputlsEPVKv
.LVL23:
	mov	x1, x20
...
.LDL1:
	.loc 2 71 0
	// Start of user assembly
// 71 "../src/arch/qemu_virt/main_test_adrp_instruction.cpp" 1
	adrp x1,label1 
	
// 0 "" 2
.LVL33:
	.loc 2 72 0
// 72 "../src/arch/qemu_virt/main_test_adrp_instruction.cpp" 1
	adrp x26,label2 
	
// 0 "" 2
.LVL34:
	.loc 2 73 0
// 73 "../src/arch/qemu_virt/main_test_adrp_instruction.cpp" 1
	adrp x25,label3 
	
// 0 "" 2
.LVL35:
	.loc 2 74 0
// 74 "../src/arch/qemu_virt/main_test_adrp_instruction.cpp" 1
	adrp x24,local_label1 
	
// 0 "" 2
.LVL36:
	.loc 2 75 0
// 75 "../src/arch/qemu_virt/main_test_adrp_instruction.cpp" 1
	adrp x23,local_label2 
	
// 0 "" 2
.LVL37:
	.loc 2 76 0
// 76 "../src/arch/qemu_virt/main_test_adrp_instruction.cpp" 1
	adrp x22,local_label3 
...
.LVL56:
	.loc 2 81 0
	// Start of user assembly
// 81 "../src/arch/qemu_virt/main_test_adrp_instruction.cpp" 1
	adr x1,local_label3 
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0x4
	.file 21 "D:\\Pool\\eclipse-workspace_aarch64\\chap003\\include/templates_implementation/MemoryManager.h"
	.byte	0x3
	.uleb128 0x59
	.uleb128 0x15
	.byte	0x5
	...
	.byte	0x4
	.byte	0x4
	.file 22 "D:\\Pool\\eclipse-workspace_aarch64\\chap003\\include/asm_instructions.h"
	.byte	0x3
	.uleb128 0x9
	.uleb128 0x16
	.byte	0x5
	.uleb128 0x9
	.4byte	.LASF807
	.file 23 "D:\\Pool\\eclipse-workspace_aarch64\\chap003\\include/arch/common_aarch64/system_common_registers.h"
	.byte	0x3
	.uleb128 0xc
	.uleb128 0x17
	.byte	0x5
	.uleb128 0x4
	.4byte	.LASF808
	.file 24 "D:\\Pool\\eclipse-workspace_aarch64\\chap003\\include/arch/common_aarch64/registers_defines.h"
	.byte	0x3
	.uleb128 0x6
	.uleb128 0x18
	.byte	0x5
...
.LASF1153:
	.string	"../src/arch/qemu_virt/main_test_adrp_instruction.cpp"
.LASF1128:
	.string	"deallocate"
.LASF941:
