	.arch armv8-a
	.file	"main_stolen_mmu.cpp"
	.text
.Ltext0:
	.cfi_sections	.debug_frame
	.align	2
	.global	_Z8mmu_initv
	.type	_Z8mmu_initv, %function
_Z8mmu_initv:
.LFB0:
	.file 1 "../src/arch/qemu_virt/main_stolen_mmu.cpp"
	.loc 1 49 0
	.cfi_startproc
.LVL0:
	.loc 1 59 0
...
.LVL7:
	...
	.loc 1 103 0
	adrp	x1, _end+20480
	add	x1, x1, :lo12:_end+20480
	orr	x1, x1, x2
	.loc 1 100 0
	str	x1, [x0, 20472]
	.loc 1 108 0
	mov	x1, 5639
	movk	x1, 0x820, lsl 16
	movk	x1, 0x40, lsl 48
	str	x1, [x0, 20480]
	.loc 1 119 0
	// Start of user assembly
// 119 "../src/arch/qemu_virt/main_stolen_mmu.cpp" 1
...
.LVL10:
	...
	movk	x0, 0x44, lsl 16
	// Start of user assembly
// 130 "../src/arch/qemu_virt/main_stolen_mmu.cpp" 1
	msr mair_el1, x0
// 0 "" 2
	.loc 1 133 0
	// End of user assembly
...
.LVL11:
	.loc 1 147 0
	// Start of user assembly
// 147 "../src/arch/qemu_virt/main_stolen_mmu.cpp" 1
	msr tcr_el1, x1; isb
// 0 "" 2
	.loc 1 151 0
	// End of user assembly
...
.LVL12:
	// Start of user assembly
// 151 "../src/arch/qemu_virt/main_stolen_mmu.cpp" 1
	msr ttbr0_el1, x1
// 0 "" 2
	.loc 1 153 0
	// End of user assembly
	...
	add	x0, x0, 1
	// Start of user assembly
// 153 "../src/arch/qemu_virt/main_stolen_mmu.cpp" 1
	msr ttbr1_el1, x0
// 0 "" 2
	.loc 1 156 0
// 156 "../src/arch/qemu_virt/main_stolen_mmu.cpp" 1
	dsb ish; isb; mrs x0, sctlr_el1
// 0 "" 2
.LVL13:
	// End of user assembly
	mov	x1, -4127
	movk	x1, 0xfcf7, lsl 16
	and	x0, x0, x1
.LVL14:
	.loc 1 166 0
	mov	x1, 2049
...
.LVL15:
	.loc 1 167 0
	// Start of user assembly
// 167 "../src/arch/qemu_virt/main_stolen_mmu.cpp" 1
	msr sctlr_el1, x0; isb
// 0 "" 2
	.loc 1 169 0
// 169 "../src/arch/qemu_virt/main_stolen_mmu.cpp" 1
	nop 
	
// 0 "" 2
	.loc 1 170 0
// 170 "../src/arch/qemu_virt/main_stolen_mmu.cpp" 1
	nop 
	
// 0 "" 2
	.loc 1 171 0
// 171 "../src/arch/qemu_virt/main_stolen_mmu.cpp" 1
	nop 
...
.LVL20:
	...
	.cfi_endproc
.LFE0:
	.size	_Z8mmu_initv, .-_Z8mmu_initv
	.align	2
	.global	main
	.type	main, %function
main:
...
.LC0:
	...
	.zero	7
.LC1:
	.string	"ERROR: 4k granule or 36 bit address space not supported\n"
	.text
.Letext0:
	...
	.file 8 "D:\\Pool\\eclipse-workspace_aarch64\\chap003\\include/printk.h"
	.file 9 "<built-in>"
...
.Ldebug_macro0:
	...
	.4byte	.Ldebug_macro1
	.byte	0x4
	.file 11 "D:\\Pool\\eclipse-workspace_aarch64\\chap003\\include/arch/qemu-virt/gpio.h"
	.byte	0x3
	.uleb128 0x9
	.uleb128 0xb
	.byte	0x5
	...
	.uleb128 0x9
	.4byte	.LASF804
	.file 15 "D:\\Pool\\eclipse-workspace_aarch64\\chap003\\include/templates_implementation/printk.h"
	.byte	0x3
	.uleb128 0x2b
	.uleb128 0xf
	.byte	0x5
...
.LASF890:
	.string	"../src/arch/qemu_virt/main_stolen_mmu.cpp"
.LASF226:
...
.LASF408:
	.string	"INCLUDE_ARCH_QEMU_VIRT_GPIO_H_ "
.LASF850:
