...
reg_defs=[
    ...
    ["","uint64_t",[["TimerValue",64]],"sys_reg_name","CNTP_TVAL_EL0"],
    ["","uint64_t",[["PhysicalCount",64]],"sys_reg_name","CNTPCT_EL0"],
    ["","uint64_t",[["VirtualCountValue",64]],"sys_reg_name","CNTVCT_EL0"],
