...
CPP_SRCS += \
D:/Pool/eclipse-workspace_aarch64/newspace/raspiOS/src/minimal_cpprt/__cxa_atexit.cpp \
D:/Pool/eclipse-workspace_aarch64/newspace/raspiOS/src/minimal_cpprt/__dso_handle.cpp \
...
src/minimal_cpprt/__cxa_atexit.o: D:/Pool/eclipse-workspace_aarch64/newspace/raspiOS/src/minimal_cpprt/__cxa_atexit.cpp
	@echo 'Building file: $<'
...
src/minimal_cpprt/__dso_handle.o: D:/Pool/eclipse-workspace_aarch64/newspace/raspiOS/src/minimal_cpprt/__dso_handle.cpp
	@echo 'Building file: $<'
	@echo 'Invoking: Cross G++ Compiler'
	aarch64-elf-g++ -std=c++14 -I"D:\Pool\eclipse-workspace_aarch64\newspace\raspiOS\include" -includecxx_macros.h -O0 -Og -g3 -pedantic -pedantic-errors -Wall -Werror -c -nostdlib -Weffc++ -Wold-style-cast -fmessage-length=0 -fmax-errors=20 -ffreestanding -fno-exceptions -fno-rtti $(USER_CXX_FLAGS) -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
	@echo 'Finished building: $<'
