...
.LFB126:
	.file 3 "D:/Pool/eclipse-workspace_aarch64/newspace/raspiOS/src/filesystem/fat/FATLongNameEntry.cpp"
	.loc 3 7 0
	.cfi_startproc
	stp	x29, x30, [sp, -96]!
...
.L8:
	...
	b	.L7
.L6:
	.loc 3 12 0 discriminator 4
	mov	w0, 0
.L7:
	.loc 3 12 0 discriminator 6
	cmp	w0, 0
	beq	.L12
	.loc 3 12 0 discriminator 7
	ldr	x0, [x29, 88]
	add	x0, x0, 2
	str	x0, [x29, 88]
	b	.L8
.L12:
	.loc 3 13 0 is_stmt 1 discriminator 8
	ldr	x0, [x29, 88]
	cmp	x0, 10
	beq	.L9
	...
	cmp	w0, 0
	beq	.L9
	.loc 3 13 0 discriminator 3
	mov	w0, 1
	b	.L10
.L9:
	.loc 3 13 0 discriminator 4
	mov	w0, 0
.L10:
	.loc 3 13 0 discriminator 6
	cmp	w0, 0
	beq	.L11
	.loc 3 14 0 is_stmt 1 discriminator 7
	add	x0, x29, 56
	ldrb	w1, [x29, 87]
	bl	_ZN6VectorIcE8pushBackEc
	.loc 3 13 0 discriminator 7
	ldr	x0, [x29, 88]
	add	x0, x0, 2
	str	x0, [x29, 88]
	b	.L12
.L11:
	...
	str	xzr, [x29, 88]
.L16:
	.loc 3 16 0 is_stmt 0 discriminator 9
	ldr	x0, [x29, 88]
	cmp	x0, 12
	beq	.L14
	.loc 3 16 0 discriminator 2
	ldr	x0, [x29, 40]
	add	x1, x0, 14
	ldr	x0, [x29, 88]
	add	x0, x1, x0
	...
	cmp	w0, 0
	beq	.L14
	.loc 3 16 0 discriminator 4
	mov	w0, 1
	b	.L15
.L14:
	.loc 3 16 0 discriminator 5
	mov	w0, 0
.L15:
	.loc 3 16 0 discriminator 7
	cmp	w0, 0
	beq	.L13
	.loc 3 17 0 is_stmt 1 discriminator 8
	add	x0, x29, 56
	ldrb	w1, [x29, 87]
	bl	_ZN6VectorIcE8pushBackEc
	.loc 3 16 0 discriminator 8
	ldr	x0, [x29, 88]
	add	x0, x0, 2
	str	x0, [x29, 88]
	b	.L16
.L13:
	...
	str	xzr, [x29, 88]
.L20:
	.loc 3 19 0 is_stmt 0 discriminator 9
	ldr	x0, [x29, 88]
	cmp	x0, 4
	beq	.L18
	.loc 3 19 0 discriminator 2
	ldr	x0, [x29, 40]
	add	x1, x0, 28
	ldr	x0, [x29, 88]
	add	x0, x1, x0
...
.L18:
	...
	mov	w0, 0
.L19:
	.loc 3 19 0 discriminator 7
	cmp	w0, 0
	beq	.L17
	.loc 3 20 0 is_stmt 1 discriminator 8
	add	x0, x29, 56
	ldrb	w1, [x29, 87]
	bl	_ZN6VectorIcE8pushBackEc
...
.L36:
	...
	b	.L38
.L35:
	.loc 3 52 0 is_stmt 1 discriminator 1
	mov	w0, 1
.L38:
	.loc 3 52 0 is_stmt 0 discriminator 3
	str	w0, [x29, 116]
	.loc 3 56 0 is_stmt 1 discriminator 3
	ldr	w0, [x29, 116]
	cmp	w0, 2
	beq	.L40
	cmp	w0, 3
...
.L40:
	...
	cmp	w0, 0
	beq	.L44
	.loc 3 62 0 discriminator 3
	mov	w0, 1
	b	.L43
.L44:
	.loc 3 62 0 discriminator 4
	mov	w0, 0
	b	.L43
.L41:
...
.LBB4:
	...
	str	xzr, [x29, 56]
.L61:
	.loc 3 101 0 is_stmt 0 discriminator 5
	ldr	x0, [x29, 56]
	cmp	x0, 10
	beq	.L58
.LBB5:
...
.LBB6:
	...
	str	xzr, [x29, 48]
.L64:
	.loc 3 102 0 is_stmt 0 discriminator 5
	ldr	x0, [x29, 48]
	cmp	x0, 12
	beq	.L62
.LBB7:
...
.LBB8:
	...
	str	xzr, [x29, 40]
.L67:
	.loc 3 103 0 is_stmt 0 discriminator 5
	ldr	x0, [x29, 40]
	cmp	x0, 4
	beq	.L65
.LBB9:
...
.LBE10:
	...
	cmp	w0, 0
	beq	.L74
	.loc 3 121 0 is_stmt 0 discriminator 2
	ldrb	w0, [x29, 23]
	cmp	w0, 0
	beq	.L75
.L74:
