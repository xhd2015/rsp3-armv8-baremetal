...
_Z4initv:
.LFB5:
	.file 1 "D:/Pool/eclipse-workspace_aarch64/newspace/raspiOS/src/arch/qemu_virt/crt0.cpp"
	.loc 1 62 0
	.cfi_startproc
	stp	x29, x30, [sp, -16]!
	...
	.loc 1 63 0
	// Start of user assembly
// 63 "D:/Pool/eclipse-workspace_aarch64/newspace/raspiOS/src/arch/qemu_virt/crt0.cpp" 1
	start_line:
...
.LBB13:
	.loc 1 17 0
	// Start of user assembly
// 17 "D:/Pool/eclipse-workspace_aarch64/newspace/raspiOS/src/arch/qemu_virt/crt0.cpp" 1
	mrs     x0, mpidr_el1 
	and     x0, x0, #3 
	cbz     x0, 2f 
	1:  	wfe	
...
.LBB15:
	.loc 1 29 0
	// Start of user assembly
// 29 "D:/Pool/eclipse-workspace_aarch64/newspace/raspiOS/src/arch/qemu_virt/crt0.cpp" 1
	ldr	x4, =UART_BASE  
	mov	w5, #0x10		
	str	w5, [x4, #0x24] 
	mov	w5, #0xc300 
...
.LBB17:
	.loc 1 37 0
	// Start of user assembly
// 37 "D:/Pool/eclipse-workspace_aarch64/newspace/raspiOS/src/arch/qemu_virt/crt0.cpp" 1
	ldr x0,=__stack_top 
	mov sp,x0 
...
.LBB19:
	.loc 1 50 0
	// Start of user assembly
// 50 "D:/Pool/eclipse-workspace_aarch64/newspace/raspiOS/src/arch/qemu_virt/crt0.cpp" 1
	ldr	x0,=__bss_start 
...
.LBB21:
	...
	.loc 2 15 0 discriminator 1
	// Start of user assembly
// 15 "D:\Pool\eclipse-workspace_aarch64\newspace\raspiOS\include/arch/qemu-virt/util.h" 1
	wfe 
...
.LASF844:
	.string	"setupUnintializedToZero"
.LASF595:
...
.LASF846:
	.string	"_Z23setupUnintializedToZerov"
.LASF664:
...
.LASF799:
	.string	"INCLUDE_ARCH_QEMU_VIRT_UTIL_H_ "
.LASF450:
...
.LASF855:
	.string	"D:/Pool/eclipse-workspace_aarch64/newspace/raspiOS/src/arch/qemu_virt/crt0.cpp"
.LASF30:
